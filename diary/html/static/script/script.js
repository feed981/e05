    ...
    methods: {
        exportDiary(event) {
            ...
            if (format === "backupjson") {
                this.backupjson();
            } else if (format === "showupjson") {
                this.showupjson();
            } else if (format === "backuphtml") {
                this.backuphtml();
            } else if (format === "showuphtml") {
                this.showuphtml();
            }
            event.target.value = "";
        },
