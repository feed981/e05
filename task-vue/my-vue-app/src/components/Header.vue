                ...
                <div class="dropdown">
                    ...
                    <ul v-show="menuStore.isOpen" class="dropdown-menu bars">
                        ...
                        <li @click="lightStore.toggleBars">
                            <i class="fa-solid" :class="{ 'fa-toggle-on': lightStore.isOpen, 'fa-toggle-off': !lightStore.isOpen }"></i>{{ lightStore.isOpen ? '|　Toggle dark-mode' : '|　Toggle light-mode' }}
                        </li>
                        ...
                        <li @click="menuStore.toggleBars"><i class="fa-solid fa-xmark"></i>|　Close the menu</li>
                    </ul>
                </div>
            </div>
        </div>
